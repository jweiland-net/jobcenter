...
return array(
    'ctrl' => array(
        ...
        'iconfile' => \TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extRelPath('jobcenter') . 'Resources/Public/Icons/tx_jobcenter_domain_model_employer_contact.gif'
    ),
    'interface' => array(
    ...
    'columns' => array(
        ...
        'salutation' => array(
            ...
            'config' => array(
                ...
                'size' => 1,
                'items' => array(
                    array('LLL:EXT:jobcenter/Resources/Private/Language/locallang_db.xlf:tx_jobcenter_domain_model_employer_contact.salutation.mr', 0),
                    array('LLL:EXT:jobcenter/Resources/Private/Language/locallang_db.xlf:tx_jobcenter_domain_model_employer_contact.salutation.mrs', 1),
                ),
            ),
        ),
        'first_name' => array(
