...
namespace JWeiland\Jobcenter\Update;
 ...
 */
#[UpgradeWizard('jobcenter_migratePluginsToContentElementsUpdate')]
class PluginToContentElementUpdate extends AbstractListTypeToCTypeUpdate
{
    protected function getListTypeToCTypeMapping(): array
    {
        return [
            'jobcenter_contact' => 'jobcenter_contact',
            'jobcenter_employercontact' => 'jobcenter_employercontact',
            'jobcenter_service' => 'jobcenter_service',
        ];
    }
    ...
    public function getDescription(): string
    {
        return 'The modern way to register plugins for TYPO3 is to register them as content element types. ' .
            'Running this wizard will migrate all jobcenter plugins to content element (CType)';
    }
}
