...
4.  Install `jobcenter`
    ...
    Use the search field to find `jobcenter`. Choose the `jobcenter` line from the search result and click on the cloud
    icon to install `jobcenter`.

Next step
=========

:ref:`Configure jobcenter <configuration>`.
